...
class _AddHomePageState extends State<AddHomePage> {
  ...
  Future<void> _fetchImagesFromServer() async {
    final url = Uri.parse('http://10.0.2.2:3000/api/homepage-promotions/get-promotion-images');
    try {
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      ...
      try {
        final url = Uri.parse('http://192.168.124.100:3004/api/homepage-promotions/add-promotion-image');
